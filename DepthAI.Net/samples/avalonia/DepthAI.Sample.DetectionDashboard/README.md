# DepthAI.Sample.DetectionDashboard

Menampilkan video kamera dengan kotak deteksi dan daftar objek yang sedang terlihat.

*Shows the camera feed with detection boxes and a list of currently visible objects.*
