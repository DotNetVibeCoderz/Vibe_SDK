# DepthAI.Sample.FaceBlur

Setiap orang yang terdeteksi dimosaik sebelum frame keluar dari aplikasi.

*Every detected person is pixelated before the frame leaves the app.*
